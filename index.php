...
<?php if (!isset($_SESSION['logged'])):?>       
    <div class="sidebaritem">
        ...
        <div class="sbicontent">
        <?php if (isset($_SESSION['name'])) echo "<font size='3px'>".$_SESSION['name']."</font>";?>
        <br>
        <br>
        <p><a href='zmenahesla.php'><font size='2px'>Zmeniť heslo</a></p>
        <br>
        <p><a href='odhlasenie.php'>Odhlásiť</font></a></p>
        </div>
        </div>
        <?php endif;?>
       <div class="sidebaritem">
